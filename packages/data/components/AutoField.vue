...
import UIFormRow from '@nuxt3-monorepo/ui/components/FormRow.vue'
import UIInputText from '@nuxt3-monorepo/ui/components/InputText.vue'
import UICheckbox from '@nuxt3-monorepo/ui/components/Checkbox.vue'

import type { IEntityAttr } from '../glocbal'
...
const input = computed(() => {
  ...
  switch (attr?.dataType) {
    case 'String':
      return buildFieldWithWrap(UIInputText)
    // case 'Number':
    //   return {
    //     cmp: CtrlInputNumber
    //   }
